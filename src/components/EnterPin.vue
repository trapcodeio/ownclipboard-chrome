<template>
  ...
  <p v-if="pinIsWrong" class="my-3 text-center text-red-400">
    Wrong Pin!
  </p>
  <div class="mt-5 text-center">
    <LoadingButton :click="forgotPin"
                   class="bg-gray-800 text-gray-500 rounded hover:bg-gray-900 hover:text-red-400">Forgot Pin?
    </LoadingButton>
  </div>
</template>
<script>
